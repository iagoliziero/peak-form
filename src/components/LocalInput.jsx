...
const LocalInput = () => {
  ...
  return (
    <div className="flex  justify-center items-center flex-col  gap-5  bg-darker rounded-md w-[21.5rem] md:w-[20rem] text-whiteMain">
      ...
      {uf && (
        <>
          <label className="text-white text-2xl  md:text-3xl font-semibold">
            Cidade
          </label>
          <select
