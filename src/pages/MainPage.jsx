  ...
  useEffect(() => {
    const getData = async () => {
      ...
      const translatedExercises = data.map((exercise) => ({
        ...exercise,
        intensity:
          intensityLevelMapping[exercise.intensity] || exercise.intensity,
      }));
          ...
          <div className="w-full h-screen bg-main-darker bg-cover bg-center bg-no-repeat flex flex-col items-center gap-5">
            ...
            {exercises.length > 0 ? (
                          ...
                          <div className="flex p-6">
                            <div className="flex flex-col gap-5">
                              <div className="flex gap-3 items-center">
                                ...
                                <H2>{exer.numberSeries}</H2>
                              </div>
                              <div className="flex gap-3 items-center">
                                <span className="text-xl text-orange font-bold">
                                  <Repeat />
                                </span>
                                <H2>{exer.repetitions}</H2>
                              </div>
                              <div className="flex gap-3 items-center">
              ...
              <div className="flex flex-col max-w-[300px] mt-16 md:max-w-[400px] md:mt-7 lg:max-w-[450px] xl:max-w-[450px] xl:mt-28">
                <h1 className="text-2xl lg:text-4xl text-yellowMain text-center font-semibold">
                  Nenhum exercício registrado.
                </h1>
                <p className="text-xl lg:text-2xl text-center text-whiteMain">
                  {" "}
                  Comece agora a criar seus exercícios e personalize seu treino.
                </p>
