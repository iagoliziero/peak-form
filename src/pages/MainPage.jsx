import { BicepsFlexed, Dumbbell, ListOrdered, Pencil, Repeat, Timer, Trash2 } from "lucide-react";
              ...
              <div className="w-[17rem] h-[24rem] 3xl:w-[20rem] bg-yellowMain rounded-lg flex-col">
                ...
                <div className="flex flex-col justify-center items-center">
                  <div className="w-[16rem] h-[19.5rem] 3xl:w-[19rem] bg-whiteMain rounded-md flex-col">
                    ...
                    <div className="flex justify-center items-center flex-grow gap-3 3xl:gap-5 relative top-3 3xl:bottom-0">
